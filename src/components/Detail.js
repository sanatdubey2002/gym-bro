...
const Detail = ({exerciseDetail}) => {
  ...
  return (
    ...
    p: "20px",alignItems: "center"}}  textTransform="capitalize" >
        <img src={gifUrl} alt={name} loading="lazy" className="detail-image" style={{borderRadius:"10px", border:"4px  solid #fae0e5"}}/>
        <Stack sx={{gap: {lg: "35px",xs: "20px"},mt:"-9rem"}}>
